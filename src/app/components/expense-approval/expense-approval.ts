...
private exportService = inject(ExportService);
  ...
  showRejectModal(expense: ExpenseResponse,type:string): void {
    ...
    this.modalRef = this.modalService.show(this.Templatepod, {class: 'modal-lg modal-dialog-centered modal-width',
      backdrop: true,
  ...
  openReasonSwal(type: string) {
    this.typeEvent = type;
    this.modalRef = this.modalService.show(this.TemplateMultipleApproval, {class: 'modal-lg modal-dialog-centered modal-width',
      backdrop: true,
      ignoreBackdropClick: true
    });
  }
